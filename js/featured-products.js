...
setTimeout(() => {
    ...
    const html = featured
      .map((game) => {
        ...
        // console.log("game before creating featuredContainer HTML: ", game);
...
// setTimeout(() => {
//   const featuredContainers = document.querySelectorAll(".game-cards");
//   // console.log("featuredContainers is: ", featuredContainers);
//   // Get the count of game containers
//   const gameCount = featuredContainers.length;
